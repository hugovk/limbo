...
def test_basic():
    with vcr.use_cassette('test/fixtures/github_issues.yaml'):
        ret = on_message({"text": "!hub issue 5 -r llimllib/limbo", "channel": "test_channel"}, SERVER)
        #import ipdb; ipdb.set_trace()
        expected = {
            'author_icon': 'https://avatars.githubusercontent.com/u/7150?v=3',
            'author_link': 'https://github.com/llimllib',
            'author_name': 'llimllib',
            'color': 'good',
            'fallback': 'Create an emoji translator',
            'text': 'i.e. if you type "I love to eat bananas", the plugin does *something* to try and convert that into a string of emoji. It probably involves a list of synonyms? Maybe even a word model? Or it does something really simple? I don\'t know, but it would be an awesome feature.',
